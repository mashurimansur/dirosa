...
@section('content')
    ...
    <div class="bg-light lter b-b wrapper-md">
        <div>
            <form method="GET" action="{{ route('kader.murobbi') }}" class="navbar-form navbar-form-xs navbar-right shift" ui-shift="prependTo" data-target=".navbar-collapse" role="search" ng-controller="TypeaheadDemoCtrl">
        ...
        <h1 class="m-n font-thin h3">Data Mudarris</h1>
    </div>
